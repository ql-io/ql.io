...
module.exports = {
    'insert into': function (test) {
        ...
        server.listen(3000, function () {
            ...
            engine.execute('update ebay.trading.SetUserNotes set Action = "AddOrUpdate", NoteText = "For Fredegonde\' birthday" where ItemID = 110099002755', function (emitter) {
