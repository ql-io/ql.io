  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_InsertStatement() {
        ...
        })(pos0.offset, pos0.line, pos0.column, result0[5], result0[9], result0[16]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
      ...
      function parse_Route() {
        ...
        if (result0 !== null) {
          result0 = (function(offset, line, column, p, m, h) {
            return {
                path: p,
                method: m,
                headers: h || {}
            }
        })(pos0.offset, pos0.line, pos0.column, result0[4], result0[10], result0[12]);
        }
        if (result0 === null) {
          pos = clone(pos0);
        }
