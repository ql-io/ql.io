    ...
    var result = {
        ...
        parse: function(input, startRule) {
            var parseFunctions = {
                ...
                "SetClause": parse_SetClause,
                "SetCriteria": parse_SetCriteria,
                "CommaEqCond": parse_CommaEqCond,
            ...
            function parse_UpdateStatement() {
                ...
                if (result0 !== null) {
                    result0 = (function(offset, line, column, s, sc, wc) {
                        return {
                            type: 'update',
                            source: s,
                            setCriteria: sc,
            ...
            function parse_SetCriteria() {
                ...
                if (result0 !== null) {
                    result0 = (function(offset, line, column, c, carr) {
                        var ret = {};
                        ret[c.lhs.name] = c.rhs.value;
                        for (var i = 0; i < carr.length; i++){
                            var temp = carr[i];
                            ret[temp.lhs.name] = temp.rhs.value;
                        }
                        return ret;
                    })(pos0.offset, pos0.line, pos0.column, result0[0], result0[1]);
                }
