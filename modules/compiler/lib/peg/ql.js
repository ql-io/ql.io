    ...
    var result = {
        ...
        parse: function(input, startRule) {
            var parseFunctions = {
                ...
                "InsertOpaqueStatement": parse_InsertOpaqueStatement,
            ...
            function parse_start() {
                ...
                if (result0 !== null) {
                    result0 = (function(offset, larr, r, carr) {
                        ret = [];
                        ret = ret.concat(larr);
                        if(r) {
                            ret.push(r);
                        ...
                        ret = ret.concat(carr);
                        return ret;
                    })(pos0, result0[1], result0[3], result0[7]);
                }
                if (result0 === null) {
                    pos = pos0;
                }
                        ...
                        if (result0 === null) {
                            ...
                            if (result0 === null) {
                                ...
                                if (result0 === null) {
                                    ...
                                    if (result0 === null) {
                                        result0 = parse_InsertOpaqueStatement();
                                        if (result0 === null) {
            ...
            function parse_Verb() {
                ...
                if (result0 !== null) {
                    result0 = (function(offset, t, m, u, a, h, d, p, b, auth, r, exp) {
                        var ret = {
                            type: t,
                            method: m,
                            uri: u.value,
                        ...
                        ret.body = b;
                        return ret;
                    })(pos0, result0[2], result0[4], result0[6], result0[8], result0[9], result0[10], result0[11], result0[13], result0[15], result0[17], result0[19]);
                }
                if (result0 === null) {
                    pos = pos0;
                }
            ...
            function parse_NVPs() {
                ...
                if (result0 !== null) {
                    result0 = (function(offset, n, narr) {
                        var ret = [n];
                        ret = ret.concat(narr);
                        return ret;
                    })(pos0, result0[0], result0[1]);
            ...
            function parse_SelectStatement() {
                ...
                if (result0 !== null) {
                    result0 = (function(offset, s, c, fc, wc, l, o) {
                        var s = {
                            type: s.type,
                            line: s.line,
                            fromClause: fc,
                        ...
                        delete s.id;
                        return s;
                    })(pos0, result0[0], result0[2], result0[6], result0[8], result0[10], result0[12]);
                }
                if (result0 === null) {
                    pos = pos0;
                }
            ...
            function parse_InsertStatement() {
                                    ...
                                    if (result5 !== null) {
                                        ...
                                        if (result6 !== null) {
                                            ...
                                            if (result7 !== null) {
                                                result8 = parse_insig();
                                                if (result8 !== null) {
                                                    result9 = parse_ColumnsClause();
                                                    if (result9 !== null) {
                                                        result10 = parse_insig();
                                                        if (result10 !== null) {
                ...
                if (result0 !== null) {
                    ...
                    })(pos0, result0[5], result0[9], result0[16]);
                }
                if (result0 === null) {
                    pos = pos0;
                }
            ...
            function parse_InsertOpaqueStatement() {
                var result0, result1, result2, result3, result4, result5, result6, result7, result8, result9, result10, result11;
                var pos0, pos1;
            ...
            function parse_FromClause() {
                ...
                if (result0 !== null) {
                    result0 = (function(offset, s, sarr) {
            ...
            function parse_WhereCriteria() {
                ...
                if (result0 !== null) {
                    result0 = (function(offset, c, carr) {
                        var ret = [c];
                        ret = ret.concat(carr);
                        return ret;
                    })(pos0, result0[0], result0[1]);
            ...
            function parse_UDF() {
                ...
                if (result0 !== null) {
                    result0 = (function(offset, name, p) {
                        return {
                            operator: 'udf',
                            name: name,
                            args: p
            ...
            function parse_Return() {
                ...
                if (result0 !== null) {
                    result0 = (function(offset, re, o, r) {
                        var ret = {
                            type: 'return',
                            line: re.line,
                            id: id,
            ...
            function parse_Route() {
                ...
                if (result0 !== null) {
                    result0 = (function(offset, p, m, h) {
                        return {
                            path: p,
                            method: m,
                            headers: h || {}
                        }
                    })(pos0, result0[4], result0[10], result0[12]);
                }
                if (result0 === null) {
                    pos = pos0;
                }
